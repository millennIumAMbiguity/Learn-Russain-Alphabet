...
namespace Learn_Russian_Alphabet
{
	public partial class Form1 : Form
	{
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			{
				MessageBox.Show(Resources.GetString("MSG-No_Speech_Synthesizer_found"));
			}
		...
		private void StartGame()
		{
			...
			do
			{
				index = _rand.Next(0, gameData.Count);
		...
		{
			if (s == null) throw new ArgumentNullException(nameof(s), Resources.GetString("MSG-Null_String"));
		...
		private void Form1_KeyPress(object sender, KeyPressEventArgs e)
		{
			...
			else if (e.KeyChar == Convert.ToChar(Keys.Escape))
			{
				...
				// reveal word
				else if (!_wordRevealed)
				{
					_wordRevealed = true;
					label.Text = _word.Values[0];
				}
				// skip
				else
				{
